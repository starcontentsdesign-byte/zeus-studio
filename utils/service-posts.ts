...
export const ALL_SERVICE_CATEGORIES_LABEL = '전체 서비스';
export const SERVICE_CATEGORIES = ['레코딩 세션', '믹싱/마스터링', '브랜드/웹 프로젝트'] as const;
export type ServiceCategory = (typeof SERVICE_CATEGORIES)[number];
export const FORCED_ADMIN_EMAIL = 'starcontents.design@gmail.com';
...
const LEGACY_SERVICE_CATEGORY_MAP: Record<string, ServiceCategory> = {
  ...
  '실물 의류': '레코딩 세션',
  '디지털 의류': '믹싱/마스터링',
  '웹사이트 스타터팩': '브랜드/웹 프로젝트'
};

const SERVICE_CATEGORY_ALIASES: Record<ServiceCategory, string[]> = {
  '레코딩 세션': ['레코딩 세션', '실물 의류', '녹음'],
  '믹싱/마스터링': ['믹싱/마스터링', '디지털 의류', '믹스/마스터'],
  '브랜드/웹 프로젝트': ['브랜드/웹 프로젝트', '웹사이트 스타터팩', '더빙/성우']
};
...
export const categoryColorPresets: Record<string, string[]> = {
  '레코딩 세션': ['#1a1a1a', '#4a4a4a', '#8a8a8a'],
  '믹싱/마스터링': ['#2a3a5a', '#4a5a7a', '#6a7a9a'],
  '브랜드/웹 프로젝트': ['#3a2a4a', '#5a4a6a', '#7a6a8a'],
};
